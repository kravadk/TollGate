...
export const services: Service[] = [
  ...
  svc({ id: "svc_arc_signal_hl", workspaceIds: ["agora"], name: "ArcMind · Hyperliquid OI Feed", category: "data", priceUsd: 0.002,
    ...
    sampleResponse: { asset: "ETH", oiValue: "<live_hyperliquid_open_interest>", fundingRate: "<live_hyperliquid_funding>", trend: "<derived_from_live_funding>" } }),
  svc({ id: "svc_arc_llm", workspaceIds: ["agora"], name: "LLM Strategy Advisor", category: "inference", priceUsd: 0.15,
    network: "arc-testnet",
    description: "Evidence-scoped strategy query over ArcMind context. Returns only sourced rationale and sizing boundaries when an LLM provider is configured.",
    sampleResponse: { advice: "<source_bound_answer>", confidence: null, model: "<configured_model>", tokensIn: null, tokensOut: null } }),
  svc({ id: "svc_arc_alert", workspaceIds: ["agora"], name: "Price Alert Stream", category: "data", priceUsd: 0.001,
    ...
    sampleResponse: { streamId: "<created_after_payment>", asset: "ETH", threshold: "<user_threshold>", direction: "<user_direction>", activatedAt: "<server_timestamp>" } }),
  svc({ id: "svc_arc_copytrade", workspaceIds: ["agora"], name: "ArcMind · CopyTrade Stake Receipt", category: "trading", priceUsd: 1.00,
    ...
    sampleResponse: { positionId: "<created_after_verified_payment>", escrow: "<configured_escrow_contract>", killThreshold: "<user_guardrail>", performanceFee: "<configured_fee_or_none>" } }),
  svc({ id: "svc_arc_usyc", workspaceIds: ["agora"], name: "USYC Yield Deposit", category: "payment", priceUsd: 0.01,
    network: "arc-testnet",
    description: "Park idle USDC into Circle USYC yield token on Arc L1. APY is shown only when the live yield feed is reachable.",
    sampleResponse: { deposited: "<verified_usdc_amount>", minted: "<actual_usyc_amount>", apy: "<live_usyc_apy>", yieldPerDay: "<computed_from_live_apy>", receiptId: "<verified_receipt_id>" } }),
  svc({ id: "svc_arc_swap", workspaceIds: ["agora"], name: "Arc DEX Swap Execution", category: "trading", priceUsd: 0.02,
    ...
    sampleResponse: { pair: "ETH/USDC", side: "<BUY_or_SELL>", amountIn: "<user_amount>", amountOut: "<quoted_from_live_price>", price: "<live_eth_usd>", slippage: "0.1%", receiptId: "<verified_receipt_id>" } }),
