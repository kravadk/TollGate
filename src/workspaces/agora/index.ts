...
export const seedRows: SeedRow[] = [
  ...
  { ws: "agora", svc: "svc_arc_portfolio", agent: "agent_arc_arb", mins: 35, status: "verified",
    kind: "agora.portfolio", name: "Portfolio Rebalance · ETH/USDC", payload: { action: "rebalance", weights: '{"ETH":50,"USDC":50}', gasFree: true, paymaster: "Circle Paymaster" } },
  { ws: "agora", svc: "svc_arc_oracle", agent: "agent_arc_arb", mins: 62, status: "verified",
    kind: "agora.oracle", name: "Arc Price Oracle · ETH/USDC gap", payload: { pair: "ETH/USDC", arcPrice: "3139.10", basePrice: "3151.40", gapBps: 92, recommended: "arb" } },
  { ws: "agora", svc: "svc_arc_arb", agent: "agent_arc_arb", mins: 65, status: "verified",
    kind: "agora.arb", name: "CCTP Cross-Chain Swap · Arc → Base", payload: { from: "arc-mainnet", to: "base", amount: "50.0", profit: "0.38", txHash: "0xarc9b1…", cctpId: "cctp_2b07" } },
